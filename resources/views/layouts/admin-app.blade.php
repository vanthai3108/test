...
{{--                    @endauth--}}
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.users.index') }}">Manager user</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.songs.index') }}">Manager song</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.singers.index') }}">Manager singer</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.genres.index') }}">Manager genre</a>
                            </li>
